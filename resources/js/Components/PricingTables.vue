            ...
            >
                <div class="mb-6">
                    ...
                    <div class="text-gray-500 mb-6">
                        ...
                        services for free to up to 100 product QR codes.
                    </div>
                    <Link
            ...
            >
                <div class="mb-6">
                    ...
                    <Link
                        class="btn w-full inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group"
                        v-if="$page.props.user"
                        :href="annual ? '/user/subscribe/basic-yearly' : '/user/subscribe/basic-monthly'"
                    >
                        Subscribe
                        <span
                            class="tracking-normal text-blue-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-2"
            ...
            >
                <div class="mb-6">
                    ...
                    <Link
                        class="btn w-full inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group"
                        v-if="$page.props.user"
                       :href="annual ? '/user/subscribe/pro-yearly' : '/user/subscribe/pro-monthly'"
                    >
                        Subscribe
                        <span
                            class="tracking-normal text-blue-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-2"
