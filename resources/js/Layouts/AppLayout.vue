...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300">
            <nav class="bg-white border-b border-gray-100 dark:bg-slate-900 border-gray-900">
