...
const mobile_links = computed(() => {
  return props.products.links.filter((el, index) => {
    if (index === 0 || index === props.products.links.length - 1 || el.active || el.link === props.products.first_page_url || el.link === props.products.last_page_url)
      return true;
    return false;
  });
});
                    ...
                    <template #button>
                      ...
                      >
                        <svg
                          ...
                          class="
                            icon icon-tabler icon-tabler-square-rounded-plus
                          "
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
            ...
            <td :colspan="fields.length + 1">
              ...
              >
                ...
                <div class="block md:hidden px-2 py-3">
                  <ul class="pagination">
                    <li v-for="(l, i) in mobile_links" :key="i">
                      <Link
                        class="pagination-link"
                        :href="l.url ? l.url : ''"
                        :data="filters"
