...
const mobile_links = computed(() => {
    return props.products.links.filter((el, index) => {
        if (
            index === 0 ||
            index === props.products.links.length - 1 ||
            el.active ||
            el.link === props.products.first_page_url ||
            el.link === props.products.last_page_url
        )
            return true;
        return false;
    });
...
<template>
    <AppLayout title="Dashboard">
        ...
        <div class="overflow-x-auto">
            ...
            >
                <thead
                    class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 sticky top-0 z-2"
                >
                    <tr>
                        <th :colspan="fields.length + 1">
                            <div
                                class="flex justify-between items-center flex-wrap space-y-2 px-3 py-2"
                            >
                                <div>
                                    <div
                                        v-show="
                    ...
                    <tr>
                        ...
                        >
                            <span
                                ...
                                :class="{
                                    'hover:cursor-pointer': field.sortable,
                                }"
                                @click="orderBy(field)"
                            >
            ...
            >
                ...
                <form class="px-4" @submit.prevent="submit">
                    ...
                    >
                        <button
                            class="btn inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 dark:hover:bg-gray-700 group"
                            type="submit"
                        >
