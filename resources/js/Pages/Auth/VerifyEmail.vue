                    ...
                    <div class="flex-1 py-8">
                        <div class="mb-10">
                            ...
                            <div class="text-sm text-gray-600">
                                ...
                                address by clicking on the link we just emailed
                                to you? If you didn't receive the email, we will
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                ...
                                <div>
                                    ...
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        class="underline text-sm text-primary hover:text-primary-focus ml-2"
                                    >
                                        Log Out
                                    </Link>
                                </div>
