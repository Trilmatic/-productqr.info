...
<template>
    ...
    <AppLayout>
        ...
        <section>
            <div class="h-56 bg-success relative">
                <div
                    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                >
                    <h2 class="h2">Subscription successfull!</h2>
                </div>
            </div>
                ...
                <div class="py-12 md:py-20">
                    <section class="md:pb-20">
                        <p class="h3 text-center">
                            Successfully subscribed to productqr.info.
                        </p>
                        <div
                            class="mt-4 text-center text-black dark:text-white text-opacity-80"
                        >
                            We will send receipt to you email adress.
                        </div>
